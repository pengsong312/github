...
<head>
	...
	function delTemplate(templateNumber){
		if(confirm("确定删除？")){
			window.location="/spring_mybatis/template/delTemplate.do?templateNumber="+templateNumber;
		}
	}
...
<body>
	...
	<div id="banner">
		<div class="container">
			...
			<div class="bannerForms pull-right">
				<form action="template/findUpdateTemplate.do">
						...
						<div class="input-group selectItem">
							<select name="style" class="form-control" autofocus="" id="style" onclick="delMaterialType()">
								...
								<c:forEach items="${templateList}" var="templateList">
									<option value="${templateList.style}">${templateList.style}</option>
								</c:forEach>
							</select>
						</div>
					</div>
	...
	<section id='wrapper'>
		<div class="container">
			<div class="row flowContent POS-R FONT12" data-label="chooseTemplate">
