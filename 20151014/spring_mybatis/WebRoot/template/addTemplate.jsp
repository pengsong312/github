	...
	<div class="container " id="panel-wrapper">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="template/addTemplatePicture.do" class="form-horizontal" id="templateForm" name ="templateForm" enctype="multipart/form-data" method="post">
				...
				<div class="detailFrame POS-R">
					...
					%>	
						<img src="<%=templatePic.getPictureList().get(i) %>" style="width: 80px;height: 80px;"/>
					...
					<input type="hidden" name="templateIntf" value="${templatePic.templateIntf}"/>
					<input type="hidden" name="pictureList" value="${templatePic.pictureList}"/>
					<br><br>
					<div class="form-group">
