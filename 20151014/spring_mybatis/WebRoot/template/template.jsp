...
<body>
	...
	<div id="banner">
		<div class="container">
			...
			<div class="bannerForms pull-right">
				<form action="template/findAllTemplate.do">
					<div class="form-group POS-R">
						<input type="text" class="form-control" name="templateIntf" id="templateIntf" value="" placeholder="输入编号"/>
					...
					<div class="form-group selectGroup">
						<div class="input-group selectItem">
							<select name="style" class="form-control" autofocus="" id="style" onclick="delMaterialType()">
	...
	<nav id="nav">
		<div class="container">
			<ul>
				...
				<li class="active"><a href="template/findAllTemplate.do">模板素材<span class="line"></a></li>
	...
	<section id='wrapper'>
		<div class="container">
			<div class="row flowContent POS-R FONT12" data-label='template'><!--
			<c:forEach items="${templateList}" var="templateList">
				<div class="col-xs-3 flowItem">
					<div class="infoBlock">
						<div class="imgBlock">
							<img src="${templateList.picture}"/>
						</div>
						<p>编号：<span>${templateList.templateIntf}</span></p>
						<p>类型：<span>${templateList.style}</span></p>
						<p>描述：<span>${templateList.describe}</span></p>
						
						<div class="mediaBlock">
							<p>
								<a href="#"><i class="fa fa-eye"></i>${templateList.look}</a>
								<a href="#"><i class="fa fa-heart"></i>${templateList.thumb}</a>
							</p>
						</div>
					</div>
					<div class="hoverBlock">
						...
						<p>编号：<span>${templateList.templateIntf}</span></p>
						<p class="text-center">
							<a href="#" class="btn btn-default">案例</a>
	...
	<section id="noMore">
		<div class="container">
			<a href="template/findAllTemplate.do" class="btn-noMore">没有更多了</a>
		</div>
	</section>
