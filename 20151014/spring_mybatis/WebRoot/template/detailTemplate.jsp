    	 ...
    	 $(document).ready(function () {
			...
			$("a.zan").on("click",function(e){
				...
				$.ajax(  
              	{  
                   type:"post",  
                   url:"template/addTemplateThumb.do",
...
<body>
	...
	<section id='wrapper'>
		<div class="container">
			<h4 class="text-center">${templateDetail.industry }公司官网设计</h4>
			<div class="discrip">
				描述：<span>${templateDetail.describe }</span>
				<input id="templateNumber" type="hidden" value="${templateDetail.templateNumber }"/>
			...
			<div class="detailFrame POS-R">
				...
				<div class="detailWindow POS-R">
					<ul>
					<%
						Template template = (Template)request.getAttribute("templateDetail");
						for(int i=0;i<template.getPictureList().size();i++){
					%>	
						<li class="active"><a href="#"><img src="<%=template.getPictureList().get(i) %>"/></a></li>
					<%
					}
