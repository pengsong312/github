	...
	<div class="container " id="panel-wrapper">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="site/addSitePicture.do" class="form-horizontal" id="siteForm" name ="siteForm" enctype="multipart/form-data" method="post">
				...
				<div class="detailFrame POS-R">
					...
					%>
						...
						<span><img src="<%=webPic.getPictureList().get(i) %>" style="width:80px;height:80px;border:10px;padding:10px;color:#000000;" /></span></a>
					...
					<input type="hidden" name="siteIntf" value="${webPic.siteIntf}"/>
					<input type="hidden" name="pictureList" value="${webPic.pictureList}"/>
					<br><br>
					<div class="form-group">
