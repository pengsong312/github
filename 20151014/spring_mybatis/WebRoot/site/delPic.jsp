...
/*		
	...
	function callBack(){
		window.location="/spring_mybatis/site/chooseSite.do";		
	}
	...
	<div class="container " id="panel-wrapper">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="site/delSitePicture.do" class="form-horizontal" id="siteForm" name ="siteForm" method="post">
				...
				<div class="detailFrame POS-R">
					...
					<input type="hidden" name="siteIntf" id="siteIntf" value="${webPic.siteIntf}"/>
					<ul>
					<% 
						WebCase webPic = (WebCase)request.getAttribute("webPic");
					%>
					<!-- <input type="checkbox" id="checkAll" name="checkall"/>全选<br/> -->
						<center><li class="active"><a>
					<%
						for(int i=0;i<webPic.getPictureList().size();i++){
					%>	
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="subBox" id="delSite" value="<%= i%>"/>&nbsp;&nbsp;
						<img src="<%=webPic.getPictureList().get(i) %>" style="width:80px;height:80px;border:10px;padding:10px;color:#000000;"/>
