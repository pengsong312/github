...
<html lang="zh-CN">
	<head>
		...
		<script src="material/js/jquery-1.11.2.min.js">
</script>
		<script src="material/js/bootstrap.min.js">
</script>
		<script src="material/js/masonry.pkgd.min.js">
</script>
		<script src="material/js/imagesloaded.pkgd.min.js">
</script>

		<script src="material/js/main.js">
</script>
<script type="text/javascript">
/*    $("#designer option").each(function () {
        var text = $(this).text();
        if ($("#designer option:contains('" + text + "')").length > 1)
            $("#designer option:contains('" + text + "'):gt(0)").remove();
    })*/
	...
	//删除素材
	function delSite(siteNumber){
		if(confirm("确定删除？")){
			window.location="/spring_mybatis/site/delSite.do?siteNumber="+siteNumber;
		}
	}
</script>
		<!-- this page script-->
...
<!--banner-->
	<div id="banner">
		<div class="container">
			...
			<form action="site/findUpdateSite.do" method="post">
				<div class="form-group POS-R">
					<input type="text" class="form-control" name="siteIntf" id="siteIntf" value="" placeholder="输入修改案例编号" />
	...
	<section id='wrapper'>
		<div class="container">
			<div class="row flowContent POS-R FONT12" data-label='chooseSite'>
			</div>
		</div>
	</section>
