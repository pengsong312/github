...
<html lang="zh-CN">
	...
	function subForm(){
		...
		if(siteIntf.length == 0|| siteIntf.length>10){
			alert("编号长度不合法！");
			document.getElementById("siteIntf").focus();
			return false;
		}
...
/*		else{
		...
		if(urlHead!="http://www."&&urlHttp!="http://"){
			alert("链接必须是http://www.或者http://格式！");
			return false;
		}
		return true;
	}
	
	function checkSiteIntf(){
		var siteIntf = $("#siteIntf").val();//id为username的文本框的值
		 $.ajax(  
              {  
                   type:"post",  
	...
	<div class="container " id="panel-wrapper">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="site/uploadSite.do" class="form-horizontal" id="siteForm" name ="siteForm" enctype="multipart/form-data" method="post">
					<div class="form-group">
					    <button class="btn btn-upload" type="button">上传网站案例</button>
					</div> 
					<div class="form-group">
					 	<label class="col-lg-1 col-lg-offset-2 control-label">选择图片：</label>
					    <div class=" col-lg-5">
					     	<input type="file" name="file" id="file" class="btn btn-upload" multiple="multiple" onclick="checkPic()"/>
					 	</div>
					...
					<div class="form-group">
					    ...
					    <div class=" col-lg-5">
					    	<input type="text" class="form-control" placeholder="" name="siteIntf" id="siteIntf"  onblur="checkSiteIntf()">
					...
					<div class="form-group">
					    ...
					    <div class=" col-lg-5">
					      	<input type="text" class="form-control" placeholder="" name="siteUrl" id="siteUrl">
					    </div>
