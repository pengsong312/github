...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		function checkRole(){
			...
			var updateUser_roleId = $("#updateUser_roleId").val();
			if(checkAdmin!="管理员"){
				$("#roleIds").val(updateUser_roleId);
				alert("对不起，您无权修改角色！");
				return false;
			}
		}
...
<body>
	...
	<div class="container " id="panel-wrapper">
		<div class="panel panel-default">
			...
			<form action="user/updateSelfMessage.do" method="post" name="updateUserMessageForm" id="updateUserMessageForm" enctype="multipart/form-data" >
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-3 col-lg-offset-2">
						...
						<input type="hidden" id="updateUser_roleId" value="${updateUser.roleIds}"/>
							角色：
						...
						<a onclick="sub()" class="btn btn-edit">确定</a>
					</div>
