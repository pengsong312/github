...
<head>
    ...
    <script type="text/javascript">
 	...
 	function delDynamic(dynamicNumber){
 		if(confirm("确定删除？")){
 			window.location="/spring_mybatis/dynamic/delDynamic.do?dynamicNumber="+dynamicNumber;
 		}
 	}
...
<body>
	...
	<div id="banner">
		<div class="container">
			...
			<div class="bannerForms pull-right">
				<form action="dynamic/findAllUpdateDynamic.do">
					...
					<div class="form-group selectGroup">
						<div class="input-group selectItem">
							<select name="materialType" class="form-control" autofocus="" id="materialType">
	...
	<section id='wrapper'>
		<div class="container">
			<div class="row flowContent POS-R FONT12" data-label="chooseDynamic">
