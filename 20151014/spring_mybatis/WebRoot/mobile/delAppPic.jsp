...
<%@page import="com.pm.mobile_case.entity.App" %>
<%
...
/*		
	...
	function callBack(){
		window.location="/spring_mybatis/mobile/chooseApp.do";		
	}
	...
	<div class="container " id="panel-wrapper">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="mobile/delAppPicture.do" class="form-horizontal" id="appForm" name ="appForm" method="post">
				...
				<div class="detailFrame POS-R">
					...
					<input type="hidden" name="appIntf" id="appIntf" value="${appPic.appIntf}"/>
					<ul>
					<% 
						App appPic = (App)request.getAttribute("appPic");
					%>
					<!-- <input type="checkbox" id="delAll" value="<%= appPic.getPictureList().size()%>"/>全选<br/>  -->
						<center><li class="active"><a>
					<%
						for(int i=0;i<appPic.getPictureList().size();i++){
					%>	
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="subBox" id="delApp" value="<%= i%>"/>&nbsp;&nbsp;
						<img src="<%=appPic.getPictureList().get(i) %>" style="width:80px;height:80px;border:10px;padding:10px;color:#000000;"/>
