...
<body>
	...
	<section id='wrapper'>
		<div class="container">
			<h4 class="text-center">${appDetail.industry }公司官网设计</h4>
			<div class="discrip">
				描述：<span>${appDetail.describe }</span>
				<input id="appNumber" type="hidden" value="${appDetail.appNumber }"/>
			...
			<div class="detailFrame POS-R">
				...
				<div class="detailWindow POS-R">
					<ul>
					<%
						App app = (App)request.getAttribute("appDetail");
						for(int i=0;i<app.getPictureList().size();i++){
					%>	
						<li class="active"><a href="#"><img src="<%=app.getPictureList().get(i) %>"/></a></li>
					<%
					}
