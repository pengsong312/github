	...
	<div class="container " id="panel-wrapper">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="mobile/addAppPicture.do" class="form-horizontal" id="appForm" name ="appForm" enctype="multipart/form-data" method="post">
				...
				<div class="detailFrame POS-R">
					...
					%>	
						<img src="<%=appPic.getPictureList().get(i) %>" style="width: 80px;height: 80px;"/>
					...
					<input type="hidden" name="appIntf" value="${appPic.appIntf}"/>
					<input type="hidden" name="pictureList" value="${appPic.pictureList}"/>
					<br><br>
					<div class="form-group">
					 	<label class="col-lg-1 col-lg-offset-2 control-label">图片增加：</label>
					    <div class=" col-lg-5">
