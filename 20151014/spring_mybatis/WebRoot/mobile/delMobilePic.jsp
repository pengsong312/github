...
/*		
	...
	function callBack(){
		window.location="/spring_mybatis/mobile/chooseMobile.do";		
	}
	...
	<div class="container " id="panel-wrapper">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="mobile/delMobilePicture.do" class="form-horizontal" id="mobileForm" name ="mobileForm" method="post">
				...
				<div class="detailFrame POS-R">
					...
					<input type="hidden" name="mobileIntf" id="mobileIntf" value="${mobilePic.mobileIntf}"/>
					<ul>
					<% 
						Mobile mobilePic = (Mobile)request.getAttribute("mobilePic");
					%>
					<!-- <input type="checkbox" id="delAll" value="<%= mobilePic.getPictureList().size()%>"/>全选<br/>  -->
						<center><li class="active"><a>
					<%
						for(int i=0;i<mobilePic.getPictureList().size();i++){
					%>	
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="subBox" id="delMobile" value="<%= i%>"/>&nbsp;&nbsp;
						<img src="<%=mobilePic.getPictureList().get(i) %>" style="width:80px;height:80px;border:10px;padding:10px;color:#000000;"/>
