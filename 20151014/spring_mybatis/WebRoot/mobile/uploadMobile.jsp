...
<html lang="zh-CN">
	...
	function subForm(){
		...
		var urlHead = mobileUrl.substr(0,11);
		
		var urlHttp = mobileUrl.substr(0,7);
		...
		if(mobileIntf.length==0||mobileIntf.length>10){
			alert("编号长度不合法！");
			document.getElementById("mobileIntf").focus();
			return false;
		}
		if(style==""){
			alert("风格不能为空！");
	...
	<div class="container " id="panel-wrapper">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="mobile/uploadMobile.do" class="form-horizontal" id="mobileForm" name ="mobileForm" enctype="multipart/form-data"  method="post">
					<div class="form-group">
					    <button class="btn btn-upload" type="button">上传手机站案例</button>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					    ...
					    <div class=" col-lg-5">
					    	<input type="text" class="form-control" placeholder="" name="mobileIntf" id="mobileIntf" onblur="checkMobileIntf()">
					...
					<div class="form-group">
					    ...
					    <div class=" col-lg-5">
					      	<input type="text" class="form-control" placeholder="" id="mobileUrl" name="mobileUrl">
					    </div>
