...
<html lang="zh-CN">
	...
	function subForm(){
		...
		var urlHead = appUrl.substr(0,11);
		
		var urlHttp = appUrl.substr(0,7);
		...
		if(appIntf.length==0||appIntf.length>10){
			alert("编号长度不合法！");
			document.getElementById("appIntf").focus();
			return false;
		}
		if(style==""){
			alert("风格不能为空！");
	...
	<div class="container " id="panel-wrapper">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="mobile/uploadApp.do" class="form-horizontal" id="appForm" name ="appForm" enctype="multipart/form-data"  method="post">
					<div class="form-group">
					    <button class="btn btn-upload" type="button">上传App案例</button>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					    ...
					    <div class=" col-lg-5">
					    	<input type="text" class="form-control" placeholder="" name="appIntf" id="appIntf" onblur="checkAppIntf()">
					...
					<div class="form-group">
					    ...
					    <div class=" col-lg-5">
					      	<input type="text" class="form-control" placeholder="" id="appUrl" name="appUrl">
					    </div>
