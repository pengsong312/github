...
<html lang="zh-CN">
	...
	function checkMobileIntf(str){
		$("#spaName").html("");
		var mobileIntf = $("#mobileIntf").val();//id为username的文本框的值
		if(str!=mobileIntf){
			$.ajax(  
              {  
                   type:"post",  
                   url:"mobile/checkMobileIntf.do",  
                   data:"mobileIntf="+$("#mobileIntf").val(),  
                   dataType:"json",  
			...
			<div class="panel-heading">
				<div>
					<span><img src="material/images/up.png" alt="" /></span>
					 手机站修改
					<a href="mobile/findAllMobile.do" class='back pull-right'>返回首页</a>
				</div>
			</div>
			
			<div class="panel-body">
				<form action="mobile/updateMobile.do" class="form-horizontal" id="siteForm" name ="siteForm" enctype="multipart/form-data" method="post">
					<div class="form-group">
					    <button class="btn btn-upload" type="button" onclick="window.location=('/spring_mybatis/mobile/chooseMobile.do')">返回</button>
					</div> 

					<input type="hidden" name="mobileNumber" value="${updateMobile.mobileNumber}"/>
					<input type="hidden" name="picture" value="${updateMobile.picture}"/>
					...
					<div class="form-group">
					    ...
					    <div class=" col-lg-5">
					    	<input type="text" class="form-control" placeholder="" name="mobileIntf" id="mobileIntf"  onblur="checkMobileIntf('${updateMobile.mobileIntf}')" value="${updateMobile.mobileIntf}">
					...
					<div class="form-group">
					    ...
					    <div class=" col-lg-5">
					      	...
					      	<select class="form-control" placeholder="" name="style" id="style" onclick="delStyle()">
					      		<option selected="selected" value="${updateMobile.style}">${updateMobile.style}</option>
					...
					<div class="form-group">
					    ...
					    <!--<input type="text" class="form-control" placeholder="" name="industry" id="industry">-->
					      	<select class="form-control" placeholder="" name="industry" id="industry" onclick="delIndustry()">
					      		<option selected="selected" value="${updateMobile.industry}">${updateMobile.industry}</option>
					...
					<div class="form-group">
					    ...
					    <div class=" col-lg-5">
					    	<select class="form-control" placeholder="" name="color" id="color" onclick="delColor()">  		
					      	<c:choose>
					    		<c:when test="${updateMobile.color=='white'}">
					    			<option value="${updateMobile.color}" selected="selected">白</option>
					    		</c:when>
					    		<c:when test="${updateMobile.color=='black'}">
					    			<option value="${updateMobile.color}" selected="selected">黑</option>
					    		</c:when>
					    		<c:when test="${updateMobile.color=='green'}">
					    			<option value="${updateMobile.color}" selected="selected">绿</option>
					    		</c:when>
					    		<c:when test="${updateMobile.color=='red'}">
					    			<option value="${updateMobile.color}" selected="selected">红</option>
					    		</c:when>
					    		<c:when test="${updateMobile.color=='blue'}">
					    			<option value="${updateMobile.color}" selected="selected">蓝</option>
					    		</c:when>
					    		<c:when test="${updateMobile.color=='orange'}">
					    			<option value="${updateMobile.color}" selected="selected">橙</option>
					    		</c:when>
					    		<c:when test="${updateMobile.color=='purple'}">
					    			<option value="${updateMobile.color}" selected="selected">紫</option>
					    		</c:when>					    		
					    		<c:when test="${updateMobile.color=='yellow'}">
					    			<option value="${updateMobile.color}" selected="selected">黄</option>
					    		</c:when>					    		
					    		<c:when test="${updateMobile.color=='gray'}">
					    			<option value="${updateMobile.color}" selected="selected">其他</option>
					    		</c:when>
					    	</c:choose>
					...
					<div class="form-group">
					    ...
					    <div class=" col-lg-5">
					      	...
					      	<select class="form-control" placeholder="" name="designer" id="designer" onclick="delDesigner()">
					      		<option selected="selected" value="${updateMobile.designer}">${updateMobile.designer}</option>
					...
					<div class="form-group">
					    ...
					    <div class=" col-lg-5">
					      	<input type="text" class="form-control" placeholder="" name="mobileUrl" id="mobileUrl" value="${updateMobile.mobileUrl}">
					    </div>
					...
					<div class="form-group">
					    ...
					    <div class=" col-lg-8">
					      	<input type="text" class="form-control" placeholder="" name="describe" id="describe" value="${updateMobile.describe}">
					    </div>
					</div>
