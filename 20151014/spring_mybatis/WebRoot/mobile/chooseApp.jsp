...
<head>
	...
	function delApp(appNumber){
		if(confirm("确定删除？")){
			window.location="/spring_mybatis/mobile/delApp.do?appNumber="+appNumber;
		}
	}
    </script>
</head>
<body>
		...
		<div class="container">
			...
			<div class="bannerForms pull-right">
				...
				<div class="mobileLink text-center">
					<a href="mobile/chooseMobile.do" class="btn btn-mobile-link">手机站</a>
					<a href="mobile/chooseApp.do" class="btn btn-mobile-link active">app</a>
				</div>
			</div>
		</div>
	</div>
	...
	<section id='wrapper'>
		<div class="container">
			<div class="row flowContent POS-R FONT12" data-label="chooseApp">
