...
<body>
		...
		<div class="container">
			...
			<div class="bannerForms pull-right">
				...
				<div class="mobileLink text-center">
					<a href="mobile/findAllMobile.do" class="btn btn-mobile-link active">手机站</a>
					<a href="mobile/findAllApp.do" class="btn btn-mobile-link ">app</a>
				</div>
			</div>
		</div>
	</div>
	...
	<section id='wrapper'>
		<div class="container">
			<h4 class="text-center">${mobileDetail.industry }公司官网设计</h4>
			<div class="discrip">
				描述：<span>${mobileDetail.describe }</span>
				<input id="mobileNumber" type="hidden" value="${mobileDetail.mobileNumber }"/>	
			...
			<div class="detailFrame POS-R">
				...
				<div class="detailWindow POS-R">
					<ul>
					<%
						Mobile mobile = (Mobile)request.getAttribute("mobileDetail");
						for(int i=0;i<mobile.getPictureList().size();i++){
					%>	
						<li class="active"><a href="#"><img src="<%=mobile.getPictureList().get(i) %>"/></a></li>
					<%
					}
